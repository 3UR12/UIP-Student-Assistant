...
UIP Student Assistant is a small, read-only browser extension for inspecting the Moodle UIP page the student already has open. Version 0.1.0 is a scanner: it identifies the current Moodle page and, where the visible DOM permits it, summarizes courses, sections, activities, and Moodle Feedback activities.
